...
function DirectoryLink(props: NavLink) {
    return (
        <Link
            href={props.link}
            className='bg-surface0 border-2 border-transparent rounded-lg drop-shadow-md md:mx-2 mx-auto my-3 px-3 md:py-4 py-3 md:max-w-56 w-11/12 transition duration-300 hover:border-subtext1 md:hover:-translate-y-1'
        >
